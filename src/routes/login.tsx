      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        <div className="glass p-8 rounded-2xl shadow-elegant">
          ...
          <button
            ...
            className="w-full h-12 flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-900 rounded-xl font-medium transition-all shadow-sm hover:shadow-md active:scale-[0.98]"
          >
