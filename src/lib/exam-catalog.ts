...
export const EXAM_CATALOG: ExamInfo[] = [
  {
    ...
    shortName: "JEE Main",
    description:
      "Joint Entrance Examination for admission to NITs, IIITs, and other engineering colleges in India.",
    country: "IN",
    icon: "⚡",
    color: "#3b82f6",
  ...
  },
  {
    ...
    shortName: "JEE Adv",
    description:
      "Advanced entrance exam for admission to IITs — India's premier engineering institutes.",
    country: "IN",
    icon: "🔥",
    color: "#ef4444",
    typicalMonth: "June",
    examPattern: {
      ...
      totalQuestions: 54,
      markingScheme:
        "Variable marking: +3/+4 for correct, -1 for wrong. Partial marking for some questions.",
    },
    subjects: [
      {
        name: "Physics",
  ...
  },
  {
    ...
    shortName: "UPSC",
    description:
      "Preliminary exam for Indian Administrative Service (IAS) and other civil services.",
    country: "IN",
    icon: "🏛️",
    color: "#f59e0b",
    typicalMonth: "June",
